                                ...
                                <c:if test="${!empty requestScope.pageInfo.list}">
                                    <c:forEach items="${requestScope.pageInfo.list}" var="admin" varStatus="myStatus">
                                        <tr>
                                            ...
                                            <td>${admin.email}</td>
                                            <td>
                                                <a href="assign/to/role/page.html?adminId=${admin.id }&pageNum=${requestScope.pageInfo.pageNum}&keyword=${param.keyword}" class="btn btn-success btn-xs"><i
                                                        class=" glyphicon glyphicon-check"></i></a>
                                                <a href="admin/edit/page.html?adminId=${admin.id }&pageNum=${requestScope.pageInfo.pageNum}" class="btn btn-primary btn-xs"><i
